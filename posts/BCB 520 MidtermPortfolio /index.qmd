...
hist(airlinesafety$incidents_85_99, main = "Incidents that have occured between 1985-1999", freq = TRUE,
     xlab = "Number of incidents in 1985 to 1999",
     ylab = "Frequency", ylim = c(0, 50))
hist(airlinesafety$incidents_00_14, main = "Incidents that have occured between 2000-2014", freq = TRUE,
...
barplot(formula = fatal_accidents_85_99 ~ airline, main="Fatal accidents that have occured between 1985-1999", data = airlinesafety[selected_85_99, ],  
...
barplot(formula = fatal_accidents_00_14 ~ airline, main="Fatal accidents that have occured between 2000-2014", data = airlinesafety[selected_00_14,],
        horiz = FALSE, cex.axis = 1,
        xlab = "Airline", xaxt = "n",
        las = 2,
